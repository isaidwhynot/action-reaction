...
-- Command     : write_vhdl -force -mode funcsim -rename_top clk_divider -prefix
--               clk_divider_ clk_divider_sim_netlist.vhdl
-- Design      : clk_divider
...
entity clk_divider_clk_divider_clk_wiz is
  port (
    clk_out : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end clk_divider_clk_divider_clk_wiz;

architecture STRUCTURE of clk_divider_clk_divider_clk_wiz is
  signal clk_in1_clk_divider : STD_LOGIC;
  signal clk_out_clk_divider : STD_LOGIC;
  signal clkfbout_buf_clk_divider : STD_LOGIC;
  signal clkfbout_clk_divider : STD_LOGIC;
