...
#
# Generated by Vivado on Thu Nov 16 00:05:19 +0300 2017
...
# Script info
echo -e "clk_divider.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot clk_divider xil_defaultlib.clk_divider -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_divider -key {Behavioral:sim_1:Functional:clk_divider} -tclbatch cmd.tcl -log simulate.log
}
